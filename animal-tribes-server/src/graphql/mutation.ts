...
import {WarriorType, SkillType, TokenType} from './type';
import {signup, login, updateTribe} from './resolver/warrior-resolver';
import {addSkill, updateSkill} from './resolver/skill-resolver';
